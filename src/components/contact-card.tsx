 ...
 * icon medallion. Used for the contact info blocks on the Kontakt
 * page against a dark panel.
 */
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-[11px] uppercase tracking-[0.3em] text-[var(--gold-700)]">
            {label}
          </p>
        </div>
        ...
        {/* Bottom accent rule */}
        <span className="absolute left-7 right-7 bottom-4 h-[1px] bg-gradient-to-r from-transparent via-[var(--gold-500)] to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left pointer-events-none" />
      </div>
    </motion.div>
  );
}
